...
10. 风险 & 压力测试（risk 块）：若出现 RISK_EXCEEDS_TOLERANCE 信号，或任一压力场景
    breach=true，**必须**对相关的高波动持仓给出 PAUSE_DCA 或 DECREASE_DCA，
    并在 risk_warnings 里明确提到对应场景名与跌幅。
...
- 目标投入规模：¥{principal_total}，应急储备：¥{emergency_reserve}
